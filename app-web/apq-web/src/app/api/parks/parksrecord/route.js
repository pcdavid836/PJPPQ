...
//IMPORTANTE ESTE NO ES EL DE ID, NO USAR ESTE CODIGO
/*
...
export async function POST(request) {
    try {
        ...
        const { fechaInicio, fechaFin, confirmacionSalida, id } = data;
        ...
        const results = await conn.query(query, [id, fechaInicio, fechaFin, confirmacionSalida]);
