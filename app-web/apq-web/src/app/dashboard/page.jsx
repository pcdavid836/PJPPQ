                ...
                <main className="col-md-10 ms-sm-auto col-lg-10 px-md-5">
                    ...
                    <div className="p-5 mb-4 bg-body-tertiary rounded-3">
                        <a href="/" className="d-flex align-items-center text-body-emphasis text-decoration-none">
                            ...
                            <span className="fs-4">Bienvenid@</span>
                        </a>
                        <div className="container-fluid py-5">
                            <h1 className="display-5 fw-bold">Enhorabuena!</h1>
                            <p className="col-md-8 fs-4">📢 Bienvenid@ a la version de presentacion del Proyecto APQ En esta actualización, se han realizado ajustes menores enfocados principalmente en la optimización de la aplicación móvil. Destaca la incorporación de mejoras relacionadas con el manejo de transacciones vía código QR, fortaleciendo así la funcionalidad financiera del sistema</p>
