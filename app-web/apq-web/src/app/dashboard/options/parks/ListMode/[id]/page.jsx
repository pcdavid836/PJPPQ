...
import FormParkList from '../../../../../../components/EditParkList/FormParkList'; // Import FormReq
...
async function EditParkListPage({ params }) {
    ...
    return (
        <div className="bg-gray-100" style={{ minHeight: '100vh' }}>
            <main className="col-md-10 ms-sm-auto col-lg-10 px-md-5">
                ...
                <div className='p-2'>
                    <FormParkList newReqId={params.id} />
                </div>
            </main>
        </div>
    )
...
export default EditParkListPage;
