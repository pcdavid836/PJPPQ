              ...
              <div className="collapse navbar-collapse justify-content-center" id="navbarsExample07">
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    <a className="nav-link active" aria-current="page" href="#">Example 1</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link active" aria-current="page" href="#">Example 2</a>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link active" aria-current="page" href="/auth/login">Login</Link>
                  </li>
                </ul>
              </div>
            </div>
